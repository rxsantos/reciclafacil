...
public class AlterarUserAsyncTask extends AsyncTask<String, String, String> {
    ...
    public AlterarUserAsyncTask(Contact obj, Context context){
    ...
    protected void onPreExecute() {
        Log.i("WebService", "AlterarUserAsyncTask()");
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            url = new URL(UtilApp.URL_WEB_SERVICE + "APIAlterarUser.php");
