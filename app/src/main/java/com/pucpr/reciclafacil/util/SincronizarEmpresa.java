...
import com.pucpr.reciclafacil.model.Company;
...
public class SincronizarEmpresa extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute(){
        Log.i("WebService","SincronizarEmpresa()");
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            url = new URL(UtilApp.URL_WEB_SERVICE+"APISincronizarEmpresa.php");
    ...
    protected void onPostExecute(String result){
        ...
        try {
            ...
            if (jsonArray.length() != 0){
                ...
                DataModel.getInstance().dlTableCompany();
                DataModel.getInstance().crTableCompany(context);
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    c.setIdlogin(jsonObject.getString("company_idlogin"));
                    ...
                    DataModel.getInstance().addCompany(c);
