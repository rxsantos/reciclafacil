...
public class IncluirEmpresaAsyncTask extends AsyncTask<String, String, String> {
    ...
    public IncluirEmpresaAsyncTask(Company obj, Context context){
        ...
        builder.appendQueryParameter("company_idlogin", obj.getIdlogin());
        builder.appendQueryParameter("name", obj.getName());
        builder.appendQueryParameter("email", obj.getEmail());
        builder.appendQueryParameter("cnpj", obj.getCnpj());
        ...
        builder.appendQueryParameter("region", obj.getRegion());
    ...
    protected void onPreExecute() {
        Log.i("WebService", "IncluirEmpresaAsyncTask()");
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            url = new URL(UtilApp.URL_WEB_SERVICE + "APIIncluirEmpresa.php");
