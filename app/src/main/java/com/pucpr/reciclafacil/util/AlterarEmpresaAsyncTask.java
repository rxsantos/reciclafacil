...
public class AlterarEmpresaAsyncTask extends AsyncTask<String, String, String> {
    ...
    public AlterarEmpresaAsyncTask(Company obj, Context context){
    ...
    protected void onPreExecute() {
        Log.i("WebService", "AlterarEmpresaAsyncTask()");
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            url = new URL(UtilApp.URL_WEB_SERVICE + "APIAlterarEmpresa.php");
