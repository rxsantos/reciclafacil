...
public class IncluirUserAsyncTask extends AsyncTask<String, String, String> {
    ...
    public IncluirUserAsyncTask(Contact obj, Context context){
    ...
    protected void onPreExecute() {
        Log.i("WebService", "IncluirUserAsyncTask()");
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            url = new URL(UtilApp.URL_WEB_SERVICE + "APIIncluirUser.php");
