...
public class ReAdicionarUserAsyncTask extends AsyncTask<String, String, String> {
    ...
    public ReAdicionarUserAsyncTask(Contact obj, Context context){
    ...
    protected void onPreExecute() {
        Log.i("WebService", "ReAdicionarUserAsyncTask()");
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            url = new URL(UtilApp.URL_WEB_SERVICE + "APIReAdicionarUser.php");
