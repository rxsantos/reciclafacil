...
public class AlterarClienteAsyncTask extends AsyncTask<String, String, String> {
    ...
    public AlterarClienteAsyncTask(Client obj, Context context){
    ...
    protected void onPreExecute() {
        Log.i("WebService", "AlterarClienteAsyncTask()");
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            url = new URL(UtilApp.URL_WEB_SERVICE + "APIAlterarCliente.php");
