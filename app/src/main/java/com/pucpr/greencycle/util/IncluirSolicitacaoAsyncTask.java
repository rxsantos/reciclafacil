...
public class IncluirSolicitacaoAsyncTask extends AsyncTask<String, String, String> {
    ...
    public IncluirSolicitacaoAsyncTask(Request obj, Context context){
    ...
    protected void onPreExecute() {
        Log.i("WebService", "IncluirSolicitacaoAsyncTask()");
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            url = new URL(UtilApp.URL_WEB_SERVICE + "APIIncluirSolicitacao.php");
